...
class _NewExpenseState extends State<NewExpense> {
  ...
  void _presentDatePicker() async {
    ...
    void _showDailog(){
      // this condition check weather its IOS or Android.
      if(Platform.isIOS){
  ...
  void _submitExpenseData() {
    final enteredAmount = double.tryParse(
        _amountController.text); // enter amount convert str to num.
  ...
  void dispose() {
    ...
    _amountController.dispose(); // Use Delete Text taken TxtEdiController.
    super.dispose();
  }
